...
import { getBoardList, loadBoardData } from '../../../api/QueryProgramApi';
...
class KanbanStore {
  ...
  axiosGetBoardList(programId) {
    return getBoardList(programId);
  }
  ...
  axiosGetBoardData(boardId, programId) {
    // const {
    //   onlyMe, onlyStory, quickSearchArray, assigneeFilterIds,
    // } = this.quickSearchObj;
    return loadBoardData(boardId, this.quickSearchObj, programId);
  }
