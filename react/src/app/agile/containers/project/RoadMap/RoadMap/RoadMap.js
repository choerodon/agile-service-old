...
import { getRoadMapInProject } from '../../../../api/QueryProgramApi';
...
class RoadMap extends Component {
  ...
  loadRoadMap = () => {
    ...
    getRoadMapInProject(programId).then((piList) => {
      this.setState({
        piList,
        loading: false,
      });
          ...
          <Spin spinning={loading}>
            ...
            piList.length > 0 ? (
              <Fragment>
                ...
                <RoadMapContent disabled piList={piList} onFeatureClick={this.handleFeatureClick} currentFeature={currentFeature} />
              </Fragment>
            ) : (
              <Empty
                style={{ marginTop: 60 }}
