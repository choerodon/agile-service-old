...
public class BoardFeatureController {
    ...
    @PostMapping
    public ResponseEntity<BoardFeatureDTO> create(@ApiParam(value = "项目id", required = true)
    ...
    public ResponseEntity<BoardFeatureDTO> update(@ApiParam(value = "项目id", required = true)
                                                  @PathVariable(name = "project_id") Long projectId,
