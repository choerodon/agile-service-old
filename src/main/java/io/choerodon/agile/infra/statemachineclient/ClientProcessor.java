package io.choerodon.agile.infra.statemachineclient;

import io.choerodon.agile.infra.statemachineclient.annotation.*;
import io.choerodon.agile.infra.statemachineclient.dto.ConfigCodeDTO;
import io.choerodon.agile.infra.statemachineclient.dto.InvokeBean;
...
public class ClientProcessor implements BeanPostProcessor {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(io.choerodon.agile.infra.statemachineclient.ClientProcessor.class);
