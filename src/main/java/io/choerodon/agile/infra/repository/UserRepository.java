...
public interface UserRepository {
    ...
    PageInfo<UserDTO> pagingQueryUsersByRoleIdOnProjectLevel(int PageInfo, int size, Long roleId, Long sourceId, RoleAssignmentSearchDTO roleAssignmentSearchDTO);
