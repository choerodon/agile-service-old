...
public class SiteMsgUtil {
    ...
    public void issueCreate(Long userId, String summary) {
    ...
    public void issueAssignee(Long userId, String summary) {
        WsSendDTO wsSendDTO = new WsSendDTO();
        wsSendDTO.setId(userId);
    ...
    public void issueSolve(Long userId, String summary) {
        WsSendDTO wsSendDTO = new WsSendDTO();
        wsSendDTO.setId(userId);
