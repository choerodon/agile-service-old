...
@NotifyBusinessType(code = "feedback-done", name = "反馈已完成", level = Level.SITE,
        description = "反馈已完成发送邮件", isAllowConfig = false, isManualRetry = true)
@Component
public class FeedbackDoneEmailTemplate implements EmailTemplate {
