...
public interface IssueComponentService {
    ...
    Page<ComponentForListDTO> queryComponentByProjectId(Long projectId, Long componentId, Boolean noIssueTest, Map<String, Object> searchParamMap, PageRequest pageRequest);
