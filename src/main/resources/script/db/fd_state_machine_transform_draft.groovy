...
databaseChangeLog(logicalFilePath: 'fd_state_machine_transform_draft.groovy') {

    changeSet(author: 'shinan.chenX@gmail.com', id: '2018-07-30-state-machine-transform-draft') {
        createTable(tableName: 'fd_state_machine_transform_draft') {
        ...
        createIndex(tableName: "fd_state_machine_transform_draft", indexName: "state_machine_transform_draft_n1") {
            column(name: "state_machine_id", type: "BIGINT UNSIGNED")
        }
        createIndex(tableName: "fd_state_machine_transform_draft", indexName: "state_machine_transform_draft_n2") {
