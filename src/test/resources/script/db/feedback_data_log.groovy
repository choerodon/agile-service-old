...
databaseChangeLog(logicalFilePath: 'script/db/feedback_data_log.groovy') {
    ...
    changeSet(id: '2019-07-24-feedback-data-log-add-index', author: 'fuqianghuang01@gmail.com') {
        createIndex(tableName: "feedback_data_log", indexName: "idx_fbdl_project_id") {
            column(name: "project_id")
        }
        createIndex(tableName: "feedback_data_log", indexName: "idx_fbdl_feedback_id") {
