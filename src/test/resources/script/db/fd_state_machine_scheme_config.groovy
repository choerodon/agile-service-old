...
databaseChangeLog(logicalFilePath: 'fd_state_machine_scheme_config.groovy') {
    changeSet(id: '2018-08-07-add-table-state-machine-scheme-config', author: 'shinan.chenX@gmail') {
        createTable(tableName: "fd_state_machine_scheme_config") {
        ...
        createIndex(tableName: "fd_state_machine_scheme_config", indexName: "state_machine_scheme_config_n1") {
            column(name: "scheme_id", type: "BIGINT UNSIGNED")
        }
        createIndex(tableName: "fd_state_machine_scheme_config", indexName: "state_machine_scheme_config_n2") {
            column(name: "issue_type_id", type: "BIGINT UNSIGNED")
        }
        createIndex(tableName: "fd_state_machine_scheme_config", indexName: "state_machine_scheme_config_n3") {
