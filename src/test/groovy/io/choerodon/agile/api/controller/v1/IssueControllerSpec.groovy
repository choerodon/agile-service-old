...
//    }
    ...
    def "deleteData"() {
        ...
        IssueComponentDO issueComponentDO2 = new IssueComponentDO()
        issueComponentDO2.name = '测试模块2'
